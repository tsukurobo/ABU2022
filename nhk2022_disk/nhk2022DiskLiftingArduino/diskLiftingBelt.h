...
public:
     ...
     * @param radius
     */
    Belt(int encoderPositiveDirection, int touchPin, long motionRange, int pwmPositiveDirection, double radius);
    uint8_t flag = 0;
    long encoder = 0;
...
public:
    // using Belt::Belt;
    Arm::Arm(int encoderPositiveDirection, int touchPin, long motionRange, int pwmPositiveDirection, double radius, Movable &movable);
    long getCurrentHeightInMM() const override;
